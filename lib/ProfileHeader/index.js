...
export default class ProfileHeader extends React.Component {
  ...
  render () {
    const BannerImageComponent = this.props.doNotCacheBanner ? Image : CacheableImage;
    const AvatarImageComponent = this.props.doNotCacheAvatar ? Image : CacheableImage;
    return (
